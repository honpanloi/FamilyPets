...
public class ImageService {
	...
	public String uploadImage(MultipartFile image, String bucketName) throws FileUploadException {
		...
		AmazonS3 s3client = AmazonS3ClientBuilder.standard().withRegion("us-west-1").build();
